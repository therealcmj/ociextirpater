...
### Available Arguments
```
usage: ociextirpate.py [-h] [-cf CONFIG_FILE] [-cp CONFIG_PROFILE] [-ip] [-dt] [-oke] [-log LOG_FILE] [-force]
...
options:
  ...
  -oke, --oke-workload-identity
                        Use OKE Workload Identity for Authentication
